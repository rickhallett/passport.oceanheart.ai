...
Rails.application.configure do
  ...
  # In production we fall back to the in-process cache to avoid relying on
  # SolidCache tables on the shared Render Postgres instance.
  config.cache_store = :memory_store, { size: 64.megabytes }

  # Use the async adapter for background jobs to avoid Solid Queue migrations.
